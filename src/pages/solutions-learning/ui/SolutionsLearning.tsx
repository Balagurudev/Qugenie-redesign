  ...
  if (designSystem === "ebay") {
    return (
      <EbaySolutionTemplate 
        ...
        subtitle="One Platform from Onboarding to Mastery" 
        description="Build the workforce of tomorrow. Course catalogue, learning path management, certification tracking, and skill matrices that connect learning to appraisal. Sector flavours ship with role-aligned learning bundles." 
        features={features}
      />
    );
  }
