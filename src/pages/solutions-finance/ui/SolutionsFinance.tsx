...
export default function SolutionsFinance() {
  ...
  if (designSystem === "ebay") {
    return (
      <EbaySolutionTemplate 
        tagline="FINANCE SOLUTION" 
        title="Finance & Accounts" 
        subtitle="One Platform for Financial Truth in Real Time" 
        description="Total control of financial health. General ledger, accounts payable and receivable, banking integration, fixed assets, period close, and e-invoicing - every transaction audit-traced from creation to filing." 
        features={features}
      />
    );
  }
  ...
  return (
    <div className="w-full flex flex-col items-center min-h-screen bg-background text-foreground pt-[120px] font-['Mirage_Display_Medium','Mirage_Display_Medium_Placeholder',sans-serif]" data-name="SolutionsFinancePage">
      ...
      <section className="w-full max-w-[1120px] px-6 py-6">
        ...
        >
          ...
          <div className="relative z-10 max-w-[600px] flex flex-col gap-2">
            <span className="bg-white dark:bg-[#111111]/10 text-white font-semibold text-[12px] uppercase tracking-widest px-3 py-1 rounded-[4px] self-start mb-2">AUDIT PROOF</span>
