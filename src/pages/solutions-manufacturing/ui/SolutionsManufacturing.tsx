...
export default function SolutionsManufacturing() {
  ...
  const features = [
    { title: "Bill of Materials (BOM)", desc: "Create multi-level BOMs with precise component routing." },
    { title: "Shop-floor Execution", desc: "Real-time logging of operations directly from the factory floor." },
    { title: "Capacity Planning", desc: "Optimize workstation load and prevent manufacturing bottlenecks." },
    { title: "Work Orders", desc: "Generate production orders automatically from sales demand." },
    { title: "Scrap Management", desc: "Track production waste and recalculate yield efficiency." },
    { title: "Subcontracting", desc: "Manage external operations and raw material transfers easily." },
    { title: "Quality Control", desc: "In-line quality parameters to ensure defect-free output." },
    { title: "Downtime Tracking", desc: "Log machine maintenance and analyze OEE (Overall Equipment Effectiveness)." },
    { title: "Production Analytics", desc: "Deep insights into manufacturing costs and cycle times." }
  ];

  if (designSystem === "ebay") {
    return (
      <EbaySolutionTemplate 
        tagline="MANUFACTURING SOLUTION" 
        title="Manufacturing Core" 
        subtitle="Precision Engineering for Modern Plants" 
        description="QuGenie Manufacturing gives you granular visibility into your factory operations. From BOM formulation to final dispatch, run a leaner, more profitable plant." 
        features={features}
      />
    );
  }
  ...
  return (
    <div className="w-full flex flex-col items-center min-h-screen bg-background text-foreground pt-[120px] font-['Mirage_Display_Medium','Mirage_Display_Medium_Placeholder',sans-serif]" data-name="SolutionsManufacturingPage">
      ...
      <section className="w-full max-w-[1120px] px-6 py-6">
        ...
        >
          ...
          <div className="relative z-10 max-w-[600px] flex flex-col gap-2">
            <span className="bg-white dark:bg-[#111111]/10 text-white font-semibold text-[12px] uppercase tracking-widest px-3 py-1 rounded-[4px] self-start mb-2">INDUSTRY 4.0</span>
      ...
      <section className="w-full max-w-[1120px] px-6 py-[60px] grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-7 flex flex-col items-start gap-4">
          <h2 className="text-[32px] md:text-[44px] lg:text-[56px] font-sans font-medium tracking-tighter uppercase leading-[1.1] text-transparent bg-clip-text bg-gradient-to-b from-white to-[#8a93a2]">
            Precision Engineering for Modern Plants
          </h2>
        </div>
        ...
        <div className="md:col-span-5 flex flex-col items-start gap-6">
          <p className="text-[16px] leading-[28px] text-muted-foreground">
            QuGenie Manufacturing gives you granular visibility into your factory operations. From BOM formulation to final dispatch, run a leaner, more profitable plant.
          </p>
          <motion.button 
