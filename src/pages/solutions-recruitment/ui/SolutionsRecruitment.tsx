...
export default function SolutionsRecruitment() {
  ...
  const features = [
    { title: "Applicant Tracking", desc: "Manage the entire candidate pipeline from source to hire." },
    { title: "Job Portals", desc: "Publish openings to your website and external job boards instantly." },
    { title: "Interview Scheduling", desc: "Automated calendar syncing and reminder notifications." },
    { title: "Pre-employment Tests", desc: "Integrate assessments to filter top talent effectively." },
    { title: "Offer Rollouts", desc: "Generate branded offer letters with digital signature support." },
    { title: "Background Checks", desc: "Initiate and track candidate verification workflows." },
    { title: "Talent Pool", desc: "Maintain a searchable database of past applicants for future roles." },
    { title: "Vendor Management", desc: "Collaborate seamlessly with external recruitment agencies." },
    { title: "Recruitment Analytics", desc: "Track time-to-fill, cost-per-hire, and pipeline bottlenecks." }
  ];

  if (designSystem === "ebay") {
    return (
      <EbaySolutionTemplate 
        tagline="TALENT SOLUTION" 
        title="Talent & Recruitment" 
        subtitle="Hire the Best, Faster" 
        description="QuGenie Recruitment streamlines your hiring process. Deliver an exceptional candidate experience while giving your HR team the tools to scale your workforce." 
        features={features}
      />
    );
  }
  ...
  return (
    <div className="w-full flex flex-col items-center min-h-screen bg-background text-foreground pt-[120px] font-['Mirage_Display_Medium','Mirage_Display_Medium_Placeholder',sans-serif]" data-name="SolutionsRecruitmentPage">
      ...
      <section className="w-full max-w-[1120px] px-6 py-6">
        ...
        >
          ...
          <div className="relative z-10 max-w-[600px] flex flex-col gap-2">
            <span className="bg-white dark:bg-[#111111]/10 text-white font-semibold text-[12px] uppercase tracking-widest px-3 py-1 rounded-[4px] self-start mb-2">TOP TALENT</span>
      ...
      <section className="w-full max-w-[1120px] px-6 py-[60px] grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-5 flex flex-col items-start gap-6">
          <p className="text-[16px] leading-[28px] text-muted-foreground">
            QuGenie Recruitment streamlines your hiring process. Deliver an exceptional candidate experience while giving your HR team the tools to scale your workforce.
          </p>
          <motion.button 
