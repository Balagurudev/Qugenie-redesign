...
export default function SolutionsVault() {
  ...
  const features = [
    {
        ...
        "desc": "Centralise drag-and-drop upload data and documents — every record, one source of truth."
    },
    {
        "title": "OCR & Entity Extraction",
        "desc": "Built-in ocr & entity extraction workflows with audit trail."
    },
    {
        "title": "Auto-routing to Modules",
        "desc": "Built-in auto-routing to modules workflows with audit trail."
    },
    {
        "title": "Sensitivity Tiering",
        "desc": "Built-in sensitivity tiering workflows with audit trail."
    },
    {
        "title": "Retention Schedules",
        "desc": "Built-in retention schedules workflows with audit trail."
    },
    {
        "title": "Access Audit Trail",
        "desc": "Built-in access audit trail workflows with audit trail."
    }
];
  ...
  if (designSystem === "ebay") {
    return (
      <EbaySolutionTemplate 
        ...
        subtitle="One Platform for Every Business Document" 
        description="One-touch document intake. Upload a bill, receipt, contract, certificate, or scan - OCR and entity extraction produce a draft transaction in the right module. Sensitivity tiering (T1-T5) governs access. Retention schedules per statutory category. Every access audit-traced." 
        features={features}
      />
    );
  }
  ...
  return (
    <div className="w-full flex flex-col items-center min-h-screen bg-background text-foreground pt-[120px] font-['Mirage_Display_Medium','Mirage_Display_Medium_Placeholder',sans-serif]" data-name="SolutionsVaultPage">
      ...
      <section className="w-full max-w-[1120px] px-6 py-[60px] grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-7 flex flex-col items-start gap-4">
          <h2 className="text-[32px] md:text-[44px] lg:text-[56px] font-sans font-medium tracking-tighter uppercase leading-[1.1] text-transparent bg-clip-text bg-gradient-to-b from-white to-[#8a93a2]">
            One Platform for Every Business Document
          </h2>
        </div>
        ...
        <div className="md:col-span-5 flex flex-col items-start gap-6">
          <p className="text-[16px] leading-[28px] text-muted-foreground">
            One-touch document intake. Upload a bill, receipt, contract, certificate, or scan — OCR and entity extraction produce a draft transaction in the right module. Sensitivity tiering (T1-T5) governs access. Retention schedules per statutory category. Every access audit-traced.
          </p>
          <motion.button 
