...
export default function SolutionsProcurement() {
  ...
  const features = [
    { title: "Vendor Portals", desc: "Give suppliers self-service access to bids, POs, and payment status." },
    { title: "Automated RFQs", desc: "Generate Request for Quotations and collect bids effortlessly." },
    { title: "Purchase Orders", desc: "Create detailed POs with tiered approval workflows." },
    { title: "Landed Costing", desc: "Accurately allocate freight, customs, and insurance to item costs." },
    { title: "Supplier Evaluation", desc: "Score vendors on delivery speed, quality, and pricing history." },
    { title: "Contract Pricing", desc: "Enforce negotiated rates and blanket orders automatically." },
    { title: "Material Requests", desc: "Allow internal teams to indent materials with ease." },
    { title: "Invoice Matching", desc: "3-way matching between PO, receipt, and vendor invoice." },
    { title: "Supply Chain Analytics", desc: "Uncover procurement bottlenecks and cost-saving opportunities." }
  ];

  if (designSystem === "ebay") {
    return (
      <EbaySolutionTemplate 
        tagline="SCM SOLUTION" 
        title="Procurement & Supply Chain" 
        subtitle="Optimize Your Sourcing Strategy" 
        description="QuGenie Procurement connects your internal demands with your external suppliers. Automate bidding, enforce budgets, and lower your operational costs." 
        features={features}
      />
    );
  }
  ...
  return (
    <div className="w-full flex flex-col items-center min-h-screen bg-background text-foreground pt-[120px] font-['Mirage_Display_Medium','Mirage_Display_Medium_Placeholder',sans-serif]" data-name="SolutionsProcurementPage">
      ...
      <section className="w-full max-w-[1120px] px-6 py-6">
        ...
        >
          ...
          <div className="relative z-10 max-w-[600px] flex flex-col gap-2">
            <span className="bg-white dark:bg-[#111111]/10 text-white font-semibold text-[12px] uppercase tracking-widest px-3 py-1 rounded-[4px] self-start mb-2">COST CONTROL</span>
      ...
      <section className="w-full max-w-[1120px] px-6 py-[60px] grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-5 flex flex-col items-start gap-6">
          <p className="text-[16px] leading-[28px] text-muted-foreground">
            QuGenie Procurement connects your internal demands with your external suppliers. Automate bidding, enforce budgets, and lower your operational costs.
          </p>
          <motion.button 
