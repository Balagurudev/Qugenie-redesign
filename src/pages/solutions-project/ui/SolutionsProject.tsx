...
export default function SolutionsProject() {
  ...
  const features = [
    { title: "Milestone Tracking", desc: "Break down complex projects into achievable milestones." },
    { title: "Timesheets", desc: "Capture billable and non-billable hours seamlessly." },
    { title: "Task Allocation", desc: "Assign tasks, set priorities, and track progress via Kanban boards." },
    { title: "Project Budgeting", desc: "Monitor estimated vs actual costs in real-time to protect margins." },
    { title: "Client Billing", desc: "Automatically generate invoices based on milestones or timesheets." },
    { title: "Resource Planning", desc: "Visualize team capacity and prevent burnout or underutilization." },
    { title: "Gantt Charts", desc: "Interactive timelines for comprehensive project scheduling." },
    { title: "Issue Tracking", desc: "Log and resolve project risks and bugs before they escalate." },
    { title: "Collaboration Hub", desc: "Centralize project documents, discussions, and approvals." }
  ];
      ...
      <section className="w-full max-w-[1120px] px-6 py-[60px] grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-7 flex flex-col items-start gap-4">
          <h2 className="text-[32px] md:text-[44px] lg:text-[56px] font-sans font-medium tracking-tighter uppercase leading-[1.1] text-transparent bg-clip-text bg-gradient-to-b from-white to-[#8a93a2]">
            Deliver Profitability on Every Project
          </h2>
        </div>
        ...
        <div className="md:col-span-5 flex flex-col items-start gap-6">
          <p className="text-[16px] leading-[28px] text-muted-foreground">
            QuGenie Projects bridges the gap between execution and finance. Ensure every billable hour is captured and every milestone is delivered on time.
          </p>
          <motion.button 
