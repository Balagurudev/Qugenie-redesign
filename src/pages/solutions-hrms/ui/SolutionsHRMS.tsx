...
export default function SolutionsHRMS() {
  ...
  const hrmsFeatures = [
    ...
    },
    {
      ...
      desc: "Built-in biometric attendance workflows with audit trail."
    },
    {
      title: "Leave Management",
      desc: "Built-in leave management workflows with audit trail."
    },
    {
      title: "Payroll & Compensation",
      desc: "Built-in payroll & compensation workflows with audit trail."
    },
    {
      title: "Performance Appraisals",
      desc: "Built-in performance appraisals workflows with audit trail."
    },
    {
      title: "Training & Development",
      desc: "Built-in training & development workflows with audit trail."
    },
    {
      title: "Expense Claims",
      desc: "Built-in expense claims workflows with audit trail."
    },
    {
      title: "Recruitment",
      desc: "Built-in recruitment workflows with audit trail."
    },
    {
      title: "Separation",
      desc: "Built-in separation workflows with audit trail."
    }
  ];
  ...
  if (designSystem === "ebay") {
    return (
      <EbaySolutionTemplate 
        tagline="HRMS SOLUTION" 
        title="HRMS - Hire for Life" 
        subtitle="One Platform for the Entire Employee Journey" 
        description="QuGenie HRMS runs the full workforce lifecycle. Recruitment, onboarding, biometric attendance, leave, payroll, performance appraisals, learning, and exit - every stage integrated, every transaction entered once." 
  ...
  return (
    <div className="w-full flex flex-col items-center min-h-screen bg-background text-foreground pt-[120px] font-['Mirage_Display_Medium','Mirage_Display_Medium_Placeholder',sans-serif]" data-name="SolutionsHRMSPage">
      ...
      <section className="w-full max-w-[1120px] px-6 py-6">
        ...
        >
          ...
          <div className="relative z-10 max-w-[600px] flex flex-col gap-2">
            <span className="bg-white dark:bg-[#111111]/10 text-white font-semibold text-[12px] uppercase tracking-widest px-3 py-1 rounded-[4px] self-start mb-2">MOST POPULAR</span>
      ...
      <section className="w-full max-w-[1120px] px-6 py-[60px] grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-5 flex flex-col items-start gap-6">
          <p className="text-[16px] leading-[28px] text-muted-foreground">
            QuGenie HRMS runs the full workforce lifecycle. Recruitment, onboarding, biometric attendance, leave, payroll, performance appraisals, learning, and exit — every stage integrated, every transaction entered once.
          </p>
          <motion.button 
