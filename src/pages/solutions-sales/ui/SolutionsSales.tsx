...
export default function SolutionsSales() {
  ...
  if (designSystem === "ebay") {
    return (
      <EbaySolutionTemplate 
        tagline="SALES & COMMERCE" 
        title="CRM & E-Commerce" 
        subtitle="One Platform from First Touch to Final Invoice" 
        description="From first touch to fulfilment. Lead capture and pipeline management flow into quotations, orders, invoices, and after-sales support. E-commerce storefront integrated where applicable. One customer record across every touchpoint." 
        features={features}
      />
    );
  }
  ...
  return (
    <div className="w-full flex flex-col items-center min-h-screen bg-background text-foreground pt-[120px] font-['Mirage_Display_Medium','Mirage_Display_Medium_Placeholder',sans-serif]" data-name="SolutionsSalesPage">
      ...
      <section className="w-full max-w-[1120px] px-6 py-6">
        ...
        >
          ...
          <div className="relative z-10 max-w-[600px] flex flex-col gap-2">
            <span className="bg-white dark:bg-[#111111]/10 text-white font-semibold text-[12px] uppercase tracking-widest px-3 py-1 rounded-[4px] self-start mb-2">GROWTH READY</span>
