  ...
  if (designSystem === "ebay") {
    return (
      <EbaySolutionTemplate 
        tagline="WAREHOUSE SOLUTION" 
        title="Inventory & Warehouse" 
        subtitle="One Platform from Procurement to Delivery" 
        description="End-to-end operations management. Vendor management and purchase orders flow into multi-warehouse inventory with batch and serial tracking. Fixed asset lifecycle and maintenance scheduling. One operations record across procurement, warehouse, and asset." 
        features={features}
      />
    );
  }
      ...
      <section className="w-full max-w-[1120px] px-6 py-6">
        ...
        >
          ...
          <div className="relative z-10 max-w-[600px] flex flex-col gap-2">
            <span className="bg-white dark:bg-[#111111]/10 text-white font-semibold text-[12px] uppercase tracking-widest px-3 py-1 rounded-[4px] self-start mb-2">SCALE READY</span>
